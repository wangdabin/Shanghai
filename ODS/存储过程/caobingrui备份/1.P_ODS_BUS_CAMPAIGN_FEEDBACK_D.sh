#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_BUS_CAMPAIGN_FEEDBACK_D
#*功能描述 --%@COMMENT: 抽取精细化营销反馈用户信息表
#*执行周期 --%@PERIOD:日
...
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.SH_BMS_CAMPAIGN_FEEDBACK
#*目标表 --%@TO:ODS.ODS_BUS_CAMPAIGN_FEEDBACK_D
####################################################################
...
table_name='ODS_BUS_CAMPAIGN_FEEDBACK_D'
