#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_BUS_SO_SERVICE_ORDER_D
#*功能描述 --%@COMMENT: 服务工单资料表
#*执行周期 --%@PERIOD:日
...
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.SO_SERVICE_ORDER
#*目标表 --%@TO:ODS.ODS_BUS_SO_SERVICE_ORDER_D
####################################################################
...
table_name='ODS_BUS_SO_SERVICE_ORDER_D'
