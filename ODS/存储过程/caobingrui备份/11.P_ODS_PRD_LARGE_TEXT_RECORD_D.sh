#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_PRD_LARGE_TEXT_RECORD_D
#*功能描述 --%@COMMENT:支撑数据业务终止原因详述解释
#*执行周期 --%@PERIOD:日
...
#*层次---%@LEVEL:ODS层 
#*主题域---%@MASTER_FIELD:产品域
#*备注 --%@REMARK: 重建数据仓库批量创建过程
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.SO_LARGE_TEXT_RECORD
#*目标表 --%@TO:ODS.ODS_PRD_LARGE_TEXT_RECORD_D
####################################################################
...
table_name='ODS_PRD_LARGE_TEXT_RECORD_D'
