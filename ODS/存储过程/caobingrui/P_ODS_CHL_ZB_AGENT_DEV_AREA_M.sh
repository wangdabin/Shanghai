#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_CHL_ZB_AGENT_DEV_AREA_M
#*功能描述 --%@COMMENT: 渠道对应表（静态表）
#*执行周期 --%@PERIOD:日
...
#*层次---%@LEVEL:ODS层 
#*主题域---%@MASTER_FIELD:渠道域
#*备注 --%@REMARK: 重建数据仓库批量创建过程
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.ZB_AGENT_CHANNEL_DEV_AREA
#*目标表 --%@TO:ODS.ODS_CHL_ZB_AGENT_DEV_AREA_M
####################################################################
...
table_name='ODS_CHL_ZB_AGENT_DEV_AREA_M'
