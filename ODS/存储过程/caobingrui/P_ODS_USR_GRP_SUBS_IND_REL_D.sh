#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_USR_GRP_SUBS_IND_REL_D
#*功能描述 --%@COMMENT:集客行业应用接口
#*执行周期 --%@PERIOD:日
...
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.GRP_SUBS_IND_REL
#*目标表 --%@TO:ODS.ODS_USR_GRP_SUBS_IND_REL_D
####################################################################
...
table_name='ODS_USR_GRP_SUBS_IND_REL_D'
