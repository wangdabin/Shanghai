#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_PUB_MAT_DELIVER_INFO_M
#*功能描述 --%@COMMENT:无
#*执行周期 --%@PERIOD:月
...
#*创建人 --%@CREATOR:王永勇
#*迁移人 --%@MOVER:曹丙瑞
#*创建时间 --%@CREATED_TIME:2014-10-31
#*层次---%@LEVEL:ODS层 
#*主题域---%@MASTER_FIELD:公共域
#*备注 --%@REMARK: 数据汇总
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.SH_MAT_DELIVER_INFO
#*目标表 --%@TO:ODS.ODS_PUB_MAT_DELIVER_INFO_M
####################################################################
...
table_name='ODS_PUB_MAT_DELIVER_INFO_M'
