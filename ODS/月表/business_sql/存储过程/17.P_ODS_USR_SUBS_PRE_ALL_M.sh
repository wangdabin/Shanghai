#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_USR_SUBS_PRE_ALL_M
#*功能描述 --%@COMMENT:区域专题>>抽取所有预备开户转正用户
#*执行周期 --%@PERIOD:月
...
#*层次---%@LEVEL:ODS层 
#*主题域---%@MASTER_FIELD:用户域
#*备注 --%@REMARK: 重建数据仓库批量创建过程
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.USER_SUBS_PRE_ALL
#*目标表 --%@TO:ODS.ODS_USR_SUBS_PRE_ALL_M
####################################################################
...
table_name='ODS_USR_SUBS_PRE_ALL_M'
