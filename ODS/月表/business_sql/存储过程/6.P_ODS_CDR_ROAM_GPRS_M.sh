#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_CDR_ROAM_GPRS_M
#*功能描述 --%@COMMENT:本地上网卡漫游流量详单
#*执行周期 --%@PERIOD:月
...
#*层次---%@LEVEL:ODS层 
#*主题域---%@MASTER_FIELD:详单域
#*备注 --%@REMARK: 重建数据仓库批量创建过程
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.ROAM_GPRS
#*目标表 --%@TO:ODS.ODS_CDR_ROAM_GPRS_M
####################################################################
...
table_name='ODS_CDR_ROAM_GPRS_M'
