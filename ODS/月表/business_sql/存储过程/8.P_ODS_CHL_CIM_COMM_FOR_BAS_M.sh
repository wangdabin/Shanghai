#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_CHL_CIM_COMM_FOR_BAS_M
#*功能描述 --%@COMMENT:从CRM2抽取佣金数据(计提)
#*执行周期 --%@PERIOD:月
...
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.CIM_COMM_FOR_BAS
#*目标表 --%@TO:ODS.ODS_CHL_CIM_COMM_FOR_BAS_M
####################################################################
...
table_name='ODS_CHL_CIM_COMM_FOR_BAS_M'
