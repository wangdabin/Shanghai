...
###################################################################
#*名称 --%@NAME:增值税发票打印记录
#*功能描述 --%@COMMENT:增值税发票打印记录沉淀
#*执行周期 --%@PERIOD:月
#*参数 --%@PARAM:V_DATE 帐期 YYYYMMDD
#*参数 --%@PARAM:V_MONTH 月份 YYYYMM
#*参数 --%@PARAM:V_DAY 当天 DD
#*创建人 --%@CREATOR:SHISUJIE
#*迁移人 --%@MOVER:曹丙瑞
#*创建时间 --%@CREATED_TIME:2014-11-06
#*层次---%@LEVEL:ODS层 
#*主题域---%@MASTER_FIELD:账务域
#*备注 --%@REMARK: 支撑上层发票打印日志表
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.BMS_VAT_PRINTINVOICE_INFO_M
#*目标表 --%@TO:ODS.ODS_BIL_PRINVOICE_INFO_M
####################################################################
...
table_name='ODS_BIL_PRINVOICE_INFO_M'
