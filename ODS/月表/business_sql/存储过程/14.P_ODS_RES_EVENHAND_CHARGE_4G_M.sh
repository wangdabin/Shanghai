#!/bin/bash
###################################################################
#*名称 --%@NAME: 4G终端外部数据-外部数据
#*功能描述 --%@COMMENT:4G预付费领卡减收
#*执行周期 --%@PERIOD:月
...
#*创建人 --%@CREATOR:蒋朝宇
#*迁移人 --%@MOVER:曹丙瑞
#*创建时间 --%@CREATED_TIME:2015-04-04
#*层次---%@LEVEL:ODS层 
#*主题域---%@MASTER_FIELD:资源域
#*备注 --%@REMARK: 
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.SRC_RES_EVENHAND_CHARGE_4G_M
#*目标表 --%@TO:ODS.ODS_RES_EVENHAND_CHARGE_4G_M
####################################################################
...
table_name='ODS_RES_EVENHAND_CHARGE_4G_M'
