...
#*创建人 --%@CREATOR:王永勇
#*迁移人 --%@MOVER:曹丙瑞
#*创建时间 --%@CREATED_TIME:  2014-05-23
#*层次---%@LEVEL:ODS层 
#*主题域---%@MASTER_FIELD:其它域
#*备注 --%@REMARK:数据汇总
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.TB_MK_BI_INF_CONT_M
#*目标表 --%@TO:ODS.ODS_M_U_BI_INF_CONT_M
####################################################################
...
table_name='ODS_M_U_BI_INF_CONT_M'
