#!/bin/bash
###################################################################
#*名称 --%@NAME:从CRM1抽取预付费领卡减收
#*功能描述 --%@COMMENT:从CRM1抽取预付费领卡减收
#*执行周期 --%@PERIOD:月
...
#*创建人 --%@CREATOR:钟 晶
#*迁移人 --%@MOVER:曹丙瑞
#*创建时间 --%@CREATED_TIME:2014-01-24
#*层次---%@LEVEL:ODS层 
#*主题域---%@MASTER_FIELD:渠道域
#*备注 --%@REMARK:
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.BMS_AGENT_DISCOUNT_BI
#*目标表 --%@TO:ODS.ODS_CHL_AGENT_DIS_M
####################################################################
...
table_name='ODS_CHL_AGENT_DIS_M'
