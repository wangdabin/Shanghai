#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_CHL_ZB_AI_MOD_CONFIG_M
#*功能描述 --%@COMMENT:从CRM2抽取总部佣金政策数据
#*执行周期 --%@PERIOD:月
...
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.ZB_AI_MOD_CONFIG
#*目标表 --%@TO:ODS.ODS_CHL_ZB_AI_MOD_CONFIG_M
####################################################################
...
table_name='ODS_CHL_ZB_AI_MOD_CONFIG_M'
