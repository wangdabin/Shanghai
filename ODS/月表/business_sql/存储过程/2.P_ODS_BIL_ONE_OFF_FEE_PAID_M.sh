#!/bin/bash
###################################################################
#*名称 --%@NAME:P_ODS_BIL_ONE_OFF_FEE_PAID_M
#*功能描述 --%@COMMENT:用于记录固网一次性费用；该表按年月分表
#*执行周期 --%@PERIOD:月
...
#*修改记录 --%@MODIFY: 暂无
#*所属于实体--%@ENTITY: 
#*来源表 --%@FROM:SRC.ACC_ONE_OFF_FEE_PAID
#*目标表 --%@TO:ODS.ODS_BIL_ONE_OFF_FEE_PAID_M
####################################################################
...
table_name='ODS.ODS_BIL_ONE_OFF_FEE_PAID_M'
